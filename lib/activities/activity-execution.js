...
internals.ActivityExecution.prototype.signal = function (definitionIdOrCallback, callback) {
    ...
    var innerCallback = function (err, execution) {
        if (typeof callback === 'function') {
            return callback(err);
        } 
    ...
    if (definitionId) {
        _self.getActivityExecutionById(definitionId, function(err, execution) {
            signalFn(execution);
        });
    } else {
        signalFn(_self);
...
internals.ActivityExecution.prototype.getActivityExecutionById = function(definitionId, callback) {
    var _self = this;
    Async.detect(_self.activityExecutions, function(ae, cb) {
